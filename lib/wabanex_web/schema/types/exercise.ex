defmodule WabanexWeb.Schema.Types.Exercise do
  ...
  input_object :create_exercise_input do
    ...
    field :youtube_video_url, non_null(:string), description: "Youtube Video URL for exercise"
    field :protocol_description, non_null(:string), description: "Protocol Description of exercise"
    field :repetitions, non_null(:string), description: "Repetitions of exercise"
  end
end
